...
public final class ProtoMessage {
  ...
  /**
   * @author Chang Xu
   * @return the Protocol.DeleteWorkerRequest
   */
  public Protocol.DeleteWorkerRequest asDeleteWorkerRequest() {
    Preconditions.checkState(mMessage instanceof Protocol.DeleteWorkerRequest);
    return (Protocol.DeleteWorkerRequest) mMessage;
  }

  /**
   * @author Chang xu
   * @return true if mMessage is of type {@link Protocol.DeleteWorkerRequest}
   */
